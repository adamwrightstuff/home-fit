...
MAJOR_HOSPITALS = [
    ...
    ("Swedish Medical Center First Hill", 47.6085, -122.3336, "large"),
    ("Swedish Medical Center Cherry Hill", 47.6085, -122.3336, "large"),
    ...
    ("Seattle Children's Hospital", 47.6626, -122.3135, "large"),
