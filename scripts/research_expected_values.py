...
def collect_location_data(location: str, area_type: str) -> Optional[Dict]:
...
def calculate_statistics(data_by_area_type: Dict[str, List[Dict]]) -> Dict:
    ...
    for area_type, locations in data_by_area_type.items():
        ...
        # Active Outdoors stats
        parks_1km = [l['active_outdoors']['parks_1km'] for l in locations]
        playgrounds_1km = [l['active_outdoors']['playgrounds_1km'] for l in locations]
        park_area = [l['active_outdoors']['park_area_hectares'] for l in locations]
        trails_15km = [l['active_outdoors']['trails_15km'] for l in locations]
        water_15km = [l['active_outdoors']['water_15km'] for l in locations]
        camping_15km = [l['active_outdoors']['camping_15km'] for l in locations]
        closest_water = [l['active_outdoors']['closest_water_km'] 
                        for l in locations if l['active_outdoors']['closest_water_km'] is not None]
        
        # Healthcare stats
        hospitals_20km = [l['healthcare']['hospitals_20km'] for l in locations]
        pharmacies_8km = [l['healthcare']['pharmacies_8km'] for l in locations]
        clinics_5km = [l['healthcare']['clinics_5km'] for l in locations]
        closest_hospital = [l['healthcare']['closest_hospital_km'] 
                           for l in locations if l['healthcare']['closest_hospital_km'] is not None]
        
        # Amenities stats
        businesses_1km = [l['amenities']['businesses_1km'] for l in locations]
        business_types = [l['amenities']['business_types'] for l in locations]
        restaurants_1km = [l['amenities']['restaurants_1km'] for l in locations]
        median_distance = [l['amenities']['median_distance_m'] 
                          for l in locations if l['amenities']['median_distance_m'] is not None]
        ...
        stats[area_type] = {
            ...
            'healthcare': {
                'hospitals_20km': calc_stats(hospitals_20km),
                'pharmacies_8km': calc_stats(pharmacies_8km),
...
def main():
    ...
    parser.add_argument('--output-dir', type=str, default='analysis/research_data',
                       help='Output directory for results')
    parser.add_argument('--area-types', nargs='+', default=None,
    ...
    for area_type in area_types:
        ...
        for location in locations:
            data = collect_location_data(location, area_type)
            if data:
    ...
    for area_type, area_stats in stats.items():
        ...
        ao = area_stats['active_outdoors']
        if ao['parks_1km']:
            print(f"  Parks (1km): median={ao['parks_1km']['median']:.1f}, "
                  f"range=[{ao['parks_1km']['p25']:.1f}, {ao['parks_1km']['p75']:.1f}]")
        
        hc = area_stats['healthcare']
        if hc['hospitals_20km']:
            print(f"  Hospitals (20km): median={hc['hospitals_20km']['median']:.1f}")
        
        am = area_stats['amenities']
        if am['businesses_1km']:
