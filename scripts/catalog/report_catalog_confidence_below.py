...
Count catalog places with one or more livability pillars below a confidence threshold.
  ...
  python3 scripts/catalog/report_catalog_confidence_below.py --metro nyc --threshold 80
  python3 scripts/catalog/report_catalog_confidence_below.py --metro la --threshold 75
  python3 scripts/catalog/report_catalog_confidence_below.py --metro all --threshold 80
