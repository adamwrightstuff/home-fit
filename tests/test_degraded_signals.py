...
class TestCollectDegradedSignals(unittest.TestCase):
    ...
    def test_built_environment_informational_height_diversity_not_degraded(self):
    ...
    def test_built_environment_informational_low_coverage_not_degraded(self):
        sig = main._collect_degraded_signals(
    ...
    def test_built_environment_api_error_is_degraded(self):
        sig = main._collect_degraded_signals(
    ...
    def test_built_environment_informational_plus_api_error_still_degraded(self):
        sig = main._collect_degraded_signals(
            {
                "details": {
