...
const METRIC_EXPLAINERS: Record<string, string> = {
  ...
  'economic_security:Unemployment rate': 'Local unemployment rate for the comparison geography.',
  'economic_security:Median earnings (area)': 'Typical annual earnings in the comparison area (dollars).',
  'economic_security:Comparison area': 'Named place or region we compare job-market stats to.',
