...
export async function GET(req: NextRequest) {
  ...
  for (const key of ['tokens', 'priorities', 'include_chains', 'diagnostics', 'only', 'job_categories', 'natural_beauty_preference', 'built_density_preference', 'diversity_preference', 'lat', 'lon', 'mode', 'trip_type', 'travel_month'] as const) {
    const v = sp.get(key);
