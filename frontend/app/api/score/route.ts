...
export async function GET(req: NextRequest) {
  ...
  for (const key of ['tokens', 'priorities', 'include_chains', 'diagnostics', 'only', 'job_categories', 'natural_beauty_preference', 'built_character_preference', 'built_density_preference'] as const) {
    const v = sp.get(key);
