...
export async function GET(req: NextRequest) {
  ...
  for (const key of ['tokens', 'priorities', 'include_chains', 'job_categories', 'only', 'natural_beauty_preference', 'built_density_preference', 'diversity_preference'] as const) {
    const v = sp.get(key);
